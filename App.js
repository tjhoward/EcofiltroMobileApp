...
import NegativeResult from './src/components/NegativeResult';
import PositiveResult from './src/components/PositiveResult';
import InconclusiveResult from './src/components/InconclusiveResult';
        ...
        <Provider store={store}>
          <Router>
            <Stack key="root" >
              ...
              <Scene key="Processing" component={Processing} hideNavBar={true} />
              <Scene key="PositiveResult" component={PositiveResult} hideNavBar={true} />
              <Scene key="NegativeResult" component={NegativeResult} hideNavBar={true} />
              <Scene key="InconclusiveResult" component={InconclusiveResult} hideNavBar={true} />
            </Stack>
          </Router>
        </Provider>
      );
